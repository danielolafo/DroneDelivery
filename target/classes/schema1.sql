...
--05/11/2025
ALTER TABLE DISPATCHES ADD COLUMN STATUS VARCHAR(20);
ALTER TABLE DISPATCHES ADD CONSTRAINT STATUS_CHK CHECK (STATUS IN ('SCHEDULED', 'ON PROGRESS', 'FINISHED','CANCELLED'));
